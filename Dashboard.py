...
qntd_vendas_estados = dados.drop_duplicates(subset='Local da compra')[['Local da compra', 'lat', 'lon']].merge(qntd_vendas_estados.rename('Quantidade'), left_on='Local da compra', right_index=True).sort_values('Quantidade', ascending=False)
...
fig_vendas_estados = px.bar(qntd_vendas_estados.head(5),
                            x='Local da compra',
                            y='Quantidade',
                            text_auto=True,
